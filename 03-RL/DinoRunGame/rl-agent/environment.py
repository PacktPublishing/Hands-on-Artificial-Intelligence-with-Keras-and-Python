...
class Environment:
    ...
    """
    actions = {Action.UP:'UP', Action.FORWARD:'FORWARD', Action.DOWN:'DOWN'}
    ...
    def start_game(self):
        """
        Starts the game and lets the Dino run for half a second and then returns the initial state.
    ...
    def do_action(self, action):
        ...
        :return: return the image of the game after performing the action, the reward (after the action) and
                        whether the Dino crashed or not.
        """
